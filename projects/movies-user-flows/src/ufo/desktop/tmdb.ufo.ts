...
export class TmdbUfo extends Ufo {
  ...
  async login(): Promise<any> {
    ...
    await this.page.screenshot().then(i => writeFileSync('./projects/movies-user-flows/src/measures/login-btn-clicked.jpg', i))
    ...
    await this.page.click(fixtures.TmdbLoginSubmitBtn);
    await this.page.waitForTimeout(6000);
    await this.page.screenshot().then(i => writeFileSync('./projects/movies-user-flows/src/measures/approve-visible.jpg', i))
    // approve access
