...
import { FallbackIcon } from './fallback-icon.token';
...
@NgModule({
  ...
  providers: [
    { provide: SuspenseIcon, useValue: () => container.children[0].cloneNode(true) },
    { provide: FallbackIcon, useValue: () => container.children[0].cloneNode(true) },
  ],
